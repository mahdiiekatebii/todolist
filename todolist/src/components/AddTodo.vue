        ...
        <div class="p-4 md:p-5">
          ...
          <div class="grid gap-4 mb-4 grid-cols-2">
            <div class="col-span-2">
              ...
              <input
                  ...
                  :value="task"
                  type="text"
                  class=" border border-gray-300  text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
            ...
            <div class="col-span-2">
              ...
              <button
                  ...
                  @click="dropDown"
                  class="text-white w-full bg-[#6C63FF] cursor-pointer  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex justify-between items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  type="button"
              >
                <p>
                  {{ labelCategory }}
          ...
          <div class="flex justify-between mt-10">
            ...
            <button
                ...
                class="cursor-pointer text-white inline-flex items-center bg-[#6C63FF]  focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-md font-bold px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              APPLY
            </button>
